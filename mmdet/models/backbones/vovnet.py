...
def dw_conv3x3(in_channels, out_channels, module_name, postfix,
    ...
    norm_ = build_norm_layer(_NORM, out_channels, postfix)[1]
    return [
        ...
        ('{}_{}/pw_norm'.format(module_name, postfix), norm_),
...
def conv3x3(
    ...
    return [
        ...
        (f"{module_name}_{postfix}/norm", norm_),
...
class VoVNet(nn.Module):
    def __init__(self, 
        ...
        # print("debug stem: ", type(stem))
        # print(OrderedDict(stem))
        stem_l = nn.Sequential(OrderedDict(stem))
        # stem_l = []
        # for s in stem:
        #     stem_l.append(s[1])
        #     print(s)
        # stem_l = nn.Sequential(*stem_l)
        self.add_module("stem", stem_l)
        current_stirde = 4
