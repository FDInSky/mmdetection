...
class SPP(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = Conv(in_channels,
                          ...
                          kernel_size=1,
                          **kwargs)
        self.conv2 = Conv(hidden_channels * (len(pooling_kernel_size) + 1),
                          out_channels,
                          kernel_size=1,
                          **kwargs)
...
class CSPStage(nn.Module):
    def __init__(self,
        ...
        self.conv_downscale = Conv(in_channels,
                                   out_channels,
                                   kernel_size=3,
                                   stride=2,
                                   **kwargs)
        self.conv_csp = BottleneckCSP(out_channels,
                                      out_channels,
                                      repetition,
                                      **kwargs)
...
class BottleneckStage(nn.Module):
    def __init__(self,
        ...
        self.conv_downscale = Conv(in_channels,
                                   ...
                                   stride=2,
                                   **kwargs)
        self.conv_bottleneck = Bottleneck(out_channels,
                                          out_channels,
                                          repetition,
                                          **kwargs)
...
class DarknetCSP(nn.Module):
    ...
    arch_settings = {
        's5p': [['conv', 'bottleneck', 'csp', 'csp', 'csp', 'csp'],
                [None, 1, 1, 3, 3, 1],
                [16, 32, 64, 128, 256, 512]],
        'm5p': [['conv', 'bottleneck', 'csp', 'csp', 'csp', 'csp'],
                [None, 1, 1, 5, 5, 3],
                [24, 48, 96, 192, 384, 768]],
        'l5p': [['conv', 'bottleneck', 'csp', 'csp', 'csp', 'csp'],
                [None, 1, 2, 8, 8, 4],
                [32, 64, 128, 256, 512, 1024]],
        'x5p': [['conv', 'bottleneck', 'csp', 'csp', 'csp', 'csp'],
                [None, 1, 3, 11, 11, 5],
                [40, 80, 160, 320, 640, 1280]],
        '6p': [['conv', 'csp', 'csp', 'csp', 'csp', 'csp', 'csp'],
               [None, 1, 3, 15, 15, 7, 7],
               [32, 64, 128, 256, 512, 1024, 1024]],
        '7p': [['conv', 'csp', 'csp', 'csp', 'csp', 'csp', 'csp', 'csp'],
               [None, 1, 3, 15, 15, 7, 7, 7],
               [40, 80, 160, 320, 640, 1280, 1280, 1280]],
    }
