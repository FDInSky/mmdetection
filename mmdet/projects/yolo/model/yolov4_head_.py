...
class YOLOV4Head(BaseDenseHead, BBoxTestMixin):
    ...
    def _init_layers(self):
        ...
        for i in range(self.num_levels):
            conv_pred = nn.Conv2d(self.in_channels[i], self.num_anchors[i] * self.num_attrib, 1)
    ...
    def get_targets_no_assigner(self,
        ...
        for lvl in range(self.num_levels):
            ...
            gt_labels_targets = F.one_hot(gt_labels_targets, num_classes=self.num_classes).float()
            if self.one_hot_smoother != 0:  # label smooth
                gt_labels_targets = gt_labels_targets * (1 - self.one_hot_smoother) + self.one_hot_smoother / self.num_classes
